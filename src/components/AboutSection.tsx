      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up">
            <h2 className="text-4xl md:text-5xl font-bold text-nature-green mb-6">Výjimečný pasivní dům</h2>
          ...
          <div className="animate-slide-up">
            <img src="/lovable-uploads/3539edde-8070-43b2-8b1f-f43bc15fa201.png" alt="Interiér pasivního domu" className="w-full h-96 object-cover rounded-lg shadow-2xl" />
          </div>
        </div>
      </div>
    </section>;
