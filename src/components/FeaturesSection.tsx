...
const FeaturesSection = () => {
  ...
  return <section id="features" className="py-20 bg-soft-stone">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-slide-up">
          <h2 className="text-4xl md:text-5xl font-bold text-nature-green mb-6">Key properties</h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">Discover all the benefits of modern passive living in this exceptional home</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {features.map((feature, index) => <div key={index} className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 animate-slide-up group cursor-pointer" style={{
